...
{
    Console.WriteLine(
        $"{release.Key} kept because it was one of the {retainReleaseCount} most recent deployments in:\n\t" +
        string.Join("\n\t", release.Distinct(
                EqualityComparer<RetainReleaseQuery.Result>.Create((rr1, rr2) =>
