public class Deployment
{
    ...
    public override string ToString() => $"Deployment: Id=\"{Id}\" ReleaseId=\"{ReleaseId}\" Release.Version=\"{Release?.Version}\" EnvironmentId=\"{EnvironmentId}\" Environment.Name=\"{Environment?.Name}\" DeployedAt=\"{DeployedAt}\"";
}